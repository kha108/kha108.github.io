...
// adding show class containing display:block, it iwll make the div visible
function showMoreInfo() {
    moreInfo.classList.add("show")
}
// removing show class containing display:block, it iwll make the div visible
...
// ------------------------------------------------------------------------
// lets work on the drop down example
...
// ------------------------------------------------------------------------
// lets work on the navigate action
